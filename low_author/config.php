...
if ( ! defined('LOW_AUTHOR_NAME'))
{
    define('LOW_AUTHOR_NAME',              'Low Author');
    define('LOW_AUTHOR_VERSION',           '1.0.0');
    define('LOW_AUTHOR_AUTHOR',            'Matthew Kirkpatrick');
    define('LOW_AUTHOR_AUTHOR_URL',        'https://github.com/javashakes');
...
/* Location: ./system/expressionengine/third_party/low_author/config.php */
